...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-lg shadow-soft border-b border-gray-100 dark:border-gray-700 sticky top-0 z-50">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div
                ...
                className="flex items-center space-x-3 bg-gray-100/50 dark:bg-gray-800/50 rounded-2xl px-4 py-2 hover:bg-gray-200/70 dark:hover:bg-gray-700/70 transition-colors duration-200 cursor-pointer hover:shadow-md"
              >
                ...
                <div className="hidden sm:block">
                  <p className="text-sm font-semibold text-gray-800 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                    {profileData?.name || user?.name}
                  </p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
